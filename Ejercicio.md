...
El equipo responsable del proyecto debe seleeccionar el tramo, que deberá cumplor los siguientes requisitos:

## Selección de la zona de actuación:

- Debe estar en una carretera de cuya titularidad corresponda a la DPZ.
- No debe afectar a ninguna de las siguientes Figuras de Protección de la Naturaleza, incluyendo su Área de Influencia Socioeconónica:
